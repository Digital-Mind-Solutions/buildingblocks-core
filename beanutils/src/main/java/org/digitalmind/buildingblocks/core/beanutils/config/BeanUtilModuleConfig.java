package org.digitalmind.buildingblocks.core.beanutils.config;
...
@Configuration
@ComponentScan({
        BeanUtilModuleConfig.SERVICE_PACKAGE
})
@Slf4j
public class BeanUtilModuleConfig {
    public static final String MODULE = "beanutils";
