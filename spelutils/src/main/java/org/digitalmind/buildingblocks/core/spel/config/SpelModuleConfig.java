package org.digitalmind.buildingblocks.core.spel.config;
...
@Configuration
@ComponentScan({
        SpelModuleConfig.SERVICE_PACKAGE
})
@Slf4j
public class SpelModuleConfig {
    public static final String MODULE = "spel";
